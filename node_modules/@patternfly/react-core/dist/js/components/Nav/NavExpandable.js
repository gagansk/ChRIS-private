      ...
      return _react.default.createElement(_Nav.NavContext.Consumer, null, function (context) {
        return _react.default.createElement(_NavToggle.default, {
          ...
          return _react.default.createElement("li", _extends({
            className: (0, _reactStyles.css)(_navCss.default.navItem, toggleValue && _navCss.default.modifiers.expanded, isActive && _navCss.default.modifiers.current, className),
            onClick: toggle
