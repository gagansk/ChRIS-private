...
function keyHandler(index, position, refsCollection, kids) {
  ...
  if (refsCollection[nextIndex] === null) {
    ...
    /* tslint:disable */
    custom ? refsCollection[nextIndex].focus && refsCollection[nextIndex].focus() || _reactDom.default.findDOMNode(refsCollection[nextIndex]).focus() : refsCollection[nextIndex].focus();
    /* tslint:enable */
  }
}