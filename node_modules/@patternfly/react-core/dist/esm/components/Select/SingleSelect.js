...
function (_React$Component) {
  ...
  function SingleSelect() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "refCollection", []);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "sendRef", function (ref, index) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "childKeyHandler", function (index, position) {
      keyHandler(index, position, _this.refCollection, _this.props.children);
    });
