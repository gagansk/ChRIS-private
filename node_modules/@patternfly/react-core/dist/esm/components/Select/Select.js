...
import { SelectContext, SelectVariant } from './selectConstants'; // seed for the aria-labelledby ID
...
function (_React$Component) {
  ...
  function Select() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "parentRef", React.createRef());
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      }, variant === 'single' && React.createElement(React.Fragment, null, React.createElement(SelectToggle, {
        id: selectToggleId,
      ...
      }, selections || placeholderText || childPlaceholderText), isExpanded && React.createElement(SingleSelect, _extends({}, props, {
        selected: selections,
