...
var menuItemContainer = function menuItemContainer(Component) {
  ...
  function (_React$Component) {
    ...
    _proto.render = function render() {
      var _this$props3 = this.props,
          ...
          props = (0, _objectWithoutPropertiesLoose2.default)(_this$props3, ["activeIndex", "id", "isOnlyResult", "label", "onActiveItemChange", "onInitialItemChange", "onMenuItemClick", "option", "position"]);
  ...
  return (0, _Context.withContext)(WrappedMenuItem, ['activeIndex', 'id', 'isOnlyResult', 'menuId', 'onActiveItemChange', 'onInitialItemChange', 'onMenuItemClick']);
};
